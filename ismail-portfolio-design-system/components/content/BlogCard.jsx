...
export function BlogCard({
  title = "The art of urban branding", category = "Branding", date = "12 Mar 2025",
  readTime = "4 min read", image, href = "#", style, ...rest
}) {
  ...
  return (
    <a href={href} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}
      ...
      <div style={{ overflow: "hidden", borderRadius: "var(--ev-radius-md)", aspectRatio: "16 / 11", background: "var(--ev-surface-media)" }}>
      ...
      <h3 style={{
        margin: 0, fontFamily: "var(--ev-font-display)", fontWeight: 700, fontSize: "var(--ev-size-h4)",
        lineHeight: 1.25, letterSpacing: "var(--ev-ls-heading)",
        textDecoration: hover ? "underline" : "none", textUnderlineOffset: "5px", textDecorationThickness: "1px"
      }}>{title}</h3>
    </a>
  );
}
